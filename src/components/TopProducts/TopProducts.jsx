    ...
    <div>
      <div className="container">
        ...
        <div className='text-left mb-24'>
            ...
            <p className='text-xs text-gray-400'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga rerum inventore voluptates.</p>
        </div>
        {/*Body Section*/}
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-20 md:gap-5 place-items-center'>
            ...
            hover:text-white relative shadow-xl duration-300 group max-w-[300px]' >
                ...
                <div className='h-[100px]'>
                    ...
                    className='max-w-[140px] block mx-auto transform -translate-y-20 group-hover:scale-110 duration-300
                drop-shadow-md'/>
                </div>
                {/*Details Section*/}
